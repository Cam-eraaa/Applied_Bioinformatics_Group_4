...
params:
  ...
  #PROseq.data: data_johan/results/cleaned/PROseq/PROseq.CBP.peak.tsv #this was fine
  ...
  results_file: results/altered_method/UMAP_combined.AllData.withMetaData.txt
  results_file_cleaned: results/altered_method/UMAP_AllData_cleaned.txt
