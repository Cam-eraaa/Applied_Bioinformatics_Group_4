...
params:
  ...
  results_file: results/altered_method/from_joint_peak/without_enhancerInsitu.combined.AllData.withMetaData.tsv
  results_file_cleaned: results/altered_method/from_joint_peak/without_enhancerInsitu.AllData_cleaned.tsv
...
# AllData_test = All %>% mutate(Enhancer_Gd7 =  ATAC_Gd7 + CBP_Gd7 + K27ac_Gd7)
...
AllData = CBPpeak.ATAC.PRO.CBP.K27ac %>% dplyr::select(
  geneID,
  Chr,
  ATAC_Start, 
  ATAC_End,
