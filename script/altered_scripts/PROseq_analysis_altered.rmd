...
params:
    ...
    PROseq.data.raw: altered.Proseq.data.raw.tsv
---
...
fileNamePROseq.raw = paste( params$workingDir, params$resultsDir,  
                        params$PROseq.data.raw,
                             sep = "/")
write.table(x = loadingsDF.all.factorDistance.max.peakInfo2, file = fileNamePROseq.raw,
                  quote = F, sep = "\t", col.names = T, row.names = F)
