...
joined = inner_join(PROseqGeneInfo, test_pairs, by="Gene_row")
joined = inner_join(our_enhancer_data, joined, by="Enhancer_row")
...
#enhancer_gene_pairs = pairs_filtered %>% dplyr::select(Enhancer_ID, Enhancer_Chr, Enhancer_Start, Enhancer_End, Gene_geneID, Gene_Chr, Gene_Start, Gene_End, PROseq_Classification, pair_score_Gd7, pair_score_Toll10b, pair_score_Toll9, pair_score_Time, EnhancerDistance)
