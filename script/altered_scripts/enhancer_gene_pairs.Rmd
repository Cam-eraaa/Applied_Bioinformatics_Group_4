...
params:
  ...
  enhancer.data: results/altered_method/from_joint_peak/combined.AllData.withMetaData.tsv
  #enhancer.data: results/altered_method/from_joint_peak/without_enhancerInsitu.combined.AllData.withMetaData.tsv
  resultsDir: results/altered_method/pairs/
  resultsFile: EGP_PCA_filtering.tsv
  #resultsFile: EGP_without_enhancerInsitu.tsv
