...
params:
  ...
  #PROseq.data: results/original_method/PROseq/PROseq.CBP.data.tsv
  ChIPseqDir: results/original_method/ChIPseq/
  #CBP.data: CBP/ChIPseq.CBP.data.tsv
  CBP.data: data_johan/results/cleaned/chipSeq/CBP-CBP_dm6.ChIPseq.peak.pattern.raw.tsv
  #K27ac.data: K27ac/ChIPseq.H3K27Ac.data.tsv
  K27ac.data: data_johan/results/cleaned/chipSeq/K27ac.ChIPseq.peak.pattern.raw.tsv
  #ATACseq.data: results/original_method/ATACseq/ATACseq.data.tsv
  ATACseq.data: data_johan/results/cleaned/ATACseq/ATACseq.data.raw.tsv
...
CBPInfo =  read.table(
  file = paste(params$workingDir, params$CBP.data, sep = ""), 
  quote = "",
  sep = "\t",
  header = TRUE,
  stringsAsFactors = F
...
K27acInfo =  read.table(
  file = paste(params$workingDir,params$K27ac.data, sep = "/"),
  quote = "",
  sep = "\t",
  header = TRUE,
  stringsAsFactors = F
...
#test = ATACseq.data %>% dplyr::select(geneID, Chr, Start, End)
#PROseqInfo2 = inner_join(PROseq.data, test, by=c("Chr", "Start", "End"))
# Rename headers.
...
#CBPpeak.ATAC.PRO.CBP.K27ac = CBPpeak.ATAC.PRO.CBP
...
# allEnhancerInfo2 = EnhancerInfo %>% dplyr::select(-geneID,-enhancerID,-enhancerGenotype,-insituID,-inSituLocation,-inSituScore,-geneID_unique,-enhancer,-inSitu,-K27ac_geneID, -Chr, -Strand, -Length, -ATAC_direction, -ATAC_factor, -ATAC_Start, -ATAC_End, -K27ac_factor, -K27ac_direction, -K27ac_Start, K27ac_End)
allEnhancerInfo2 = EnhancerInfo %>% dplyr::select(-geneID,-enhancerID,-enhancerGenotype,-insituID,-inSituLocation,-inSituScore,-geneID_unique,-enhancer,-inSitu,-K27ac_geneID, -Chr, -Strand, -Length, -ATAC_direction, -ATAC_factor, -ATAC_Start, -ATAC_End)
allEnhancerInfo2.rownames = allEnhancerInfo2$geneID_unique
