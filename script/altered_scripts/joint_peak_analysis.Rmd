...
#allEnhancerInfo2 = EnhancerInfo %>% dplyr::select(-geneID,-enhancerID,-enhancerGenotype,-insituID,-inSituLocation,-inSituScore,-geneID_unique,-enhancer,-inSitu,-K27ac_geneID, ATAC_Time)
