...
<!-- Below the mysterious variable PROseq.data appears and I try to identify where it comes from but didn't succeed -->
...
<!--              file = paste( params$workingDir, params$proSeqDir, "selectedGenes.tsv" ,sep = "/"), -->
