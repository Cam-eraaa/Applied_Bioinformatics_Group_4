...
loadingsDF.all.factorDistance.max = inner_join(loadingsDF.all.factorDistance,
                                               ...
                                               by = "geneID") %>% dplyr::select(geneID, factor, direction)
...
fileNamePROseq1 = paste(params$workingDir,
                       params$resultsDir,
                       params$PROseq.data,
                       sep = "/")
# write.table(
#   x = loadingsDF.all.factorDistance.max.peakInfo2,
#   file = fileNamePROseq1,
#   quote = F,
#   sep = "\t",
#   col.names = T,
#   row.names = F
...
#loadings_out = loadingsDF.all.factorDistance.max.peakInfo2 %>% dplyr::select(-replicate, -bamFile, -sampleName)
#fileNamePROseq2 = paste(params$workingDir,
#                       params$resultsDir,
