...
# Rename it to clarify the content
geneInfo = positions_fixed
```
...
Remove all genes that is not expressed in any sample and start adding known information about the genes. This is done by only keeing the genes with total counts larger than 0.
