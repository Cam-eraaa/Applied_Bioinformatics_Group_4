...
params:
  ...
  Antibody: CBP
  ATACresultsDir: results/original_method/ChIPseq/CBP
  ATACSeq.data.raw: ChIPseq.CBP.data.tsv
---
...
#loadingsDF.all.factorDistance.max = loadingsDF.all.factorDistance.max %>% rename(geneID = Geneid)

loadingsDF.all.factorDistance.max.peakInfo = inner_join (peakInfo,loadingsDF.all.factorDistance.max)

#loadingsDF.all.factorDistance2 = loadingsDF.all.factorDistance2 %>% rename(geneID = Geneid)
...
fileNameATACseq = paste( params$workingDir, params$ATACresultsDir,  
