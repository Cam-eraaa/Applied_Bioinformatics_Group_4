...
DEGenens = left_join(toll10b_3h_vs_5h,toll9_3h_vs_5h)
DEGenens = left_join(DEGenens,gd7_3h_vs_5h)

#select only rows that will be used.
similair = DEGenens%>% dplyr::select(l2fc_toll10b_3h_vstoll10b_5h,l2fc_gd7_3h_vsgd7_5h,l2fc_toll9_3h_vstoll9_5h,ENSEMBL)
...
DEGenens %>% dplyr::filter(ENSEMBL == "FBgn0002733")
FBgn0002733
