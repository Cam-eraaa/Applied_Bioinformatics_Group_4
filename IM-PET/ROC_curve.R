...
resultsGd7_3h = read.table("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/out_Gd7_3h.txt", header = TRUE, 
                      sep = "\t", quote = "",  
...
jpeg("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/ROCGd7_3h.jpg", width = 650, height = 650)
...
dev.off()
resultsGd7_5h = read.table("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/out_Gd7_5h.txt", header = TRUE, 
                           sep = "\t", quote = "",  
                           stringsAsFactors = FALSE)
...
jpeg("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/ROCGd7_5h.jpg", width = 650, height = 650)
ggplot(ROCplotInfoGd7_5h, mapping =  aes(x = FPR, y = TPR, color = score))+
  ...
  facet_grid(.~classifier)
dev.off()
resultsToll9_3h = read.table("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/out_Toll9_3h.txt", header = TRUE, 
                           sep = "\t", quote = "",  
                           stringsAsFactors = FALSE)
...
jpeg("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/ROCToll9_3h.jpg", width = 650, height = 650)
ggplot(ROCplotInfoToll9_3h, mapping =  aes(x = FPR, y = TPR, color = score))+
  ...
  facet_grid(.~classifier)
dev.off()
resultsToll9_5h = read.table("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/out_Toll9_5h.txt", header = TRUE, 
                           sep = "\t", quote = "",  
                           stringsAsFactors = FALSE)
...
jpeg("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/ROCToll9_5h.jpg", width = 650, height = 650)
...
resultsToll10b_3h = read.table("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/out_Toll10b_3h.txt", header = TRUE, 
                             sep = "\t", quote = "",  
                             stringsAsFactors = FALSE)
...
jpeg("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/ROCToll10b_3h.jpg", width = 650, height = 650)
...
resultsToll10b_5h = read.table("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/out_Toll10b_5h.txt", header = TRUE, 
                             sep = "\t", quote = "",  
                             stringsAsFactors = FALSE)
...
jpeg("/Users/Camille/Desktop/IM-PET_TEST/python_scripts/Prediction_filtering/ROCToll10b_5h.jpg", width = 650, height = 650)
